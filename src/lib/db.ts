    ...
    try {
      ...
      if (count.count === 0) {
        ...
        const seedData = [
          ...
          ["Retro Glide", "APEX SOLES", 1500.00, "Classic", "Vintage-inspired design with modern comfort technology. Bringing back the 80s vibe.", "https://images.unsplash.com/photo-1512374382149-4332c6c02151?q=80&w=400&auto=format&fit=crop", "Heritage Red"],
        ];
